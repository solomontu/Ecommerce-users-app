...
import 'package:flutter_ecom/admin/constants/constants.dart';
...
class AddProduct extends StatefulWidget {
  // final BrandGoryModel brand;
  // final BrandGoryModel category;

  // const AddProduct({Key key, this.brand, this.category}) : super(key: key);
  @override
...
class _AddProductState extends State<AddProduct> {
  ...
  Widget build(BuildContext context) {
    BrandGoryProvider _brandGory = Provider.of<BrandGoryProvider>(context);
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          ...
                          child: DropdownButton<String>(
                              ...
                              items: _brandGory.brandList.map((value) {
                                return DropdownMenuItem<String>(
                                    value: value.toString(),
